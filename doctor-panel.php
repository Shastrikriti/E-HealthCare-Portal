...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans&display=swap" rel="stylesheet">
      <nav style="background-color: #3931af;" class="navbar navbar-expand-lg navbar-dark fixed-top">
    <h1><a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"> </i>E-Heathcare Portal</a></h1>
...
.text-primary {
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h2 style = "margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Welcome &nbsp<?php echo $_SESSION['dname'] ?>  </h2>
    <div class="row">
