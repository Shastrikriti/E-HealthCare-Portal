...
<html lang="en">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #3931af;" >

    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <h1><a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> E-Healthcare Portal</a></h1>
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h1 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;"> WELCOME ADMINISTRATOR </h1>
    <div class="row">
          ...
          <div class="col-md-4"><label>Doctor Name:</label></div>
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Endocrinologists" name="spec">Endocrinologists</option>
                      <option value="Gastroenterologists" name="spec">Gastroenterologists</option>
                      <option value="Gynecologist" name="spec">Gynecologist</option>
                      <option value="Oncologist" name="spec">Oncologist</option>
                      <option value="Ophthalmologists" name="spec">Ophthalmologists</option>
