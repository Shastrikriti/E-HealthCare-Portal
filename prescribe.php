...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans&display=swap" rel="stylesheet">
      <nav style="background: #3931af;" class="navbar navbar-expand-lg navbar-dark fixed-top">
      <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> E-Healthcare Portal</a>
          ...
          <div class="row">
            <div class="container">
              <div class="form-group">
                <label>Disease:</label>
                <textarea id="disease" class="form-control" rows ="4" name="disease" required></textarea>
              </div>
    
              <div class="form-group">
                <label>Allergies:</label>
                <textarea id="allergy" class="form-control" rows ="4" name="allergy" required></textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea id="prescription"class="form-control" rows ="5" name="prescription" required></textarea>
                      ...
                      <br><br>
                  <input type="submit" name="prescribe" value="Prescribe" class="btn text-white" style="margin-left: 40pc;background: #3931af;">
            </div>
          </div>
