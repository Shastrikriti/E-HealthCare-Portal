...
<html lang="en">
  ...
  <a class="navbar-brand" href="admin-panel.php"> E-Healthcare Portal</a>
                      ...
                      <tr>
                        ...
                        <td>
                          <form method="get">
                              ...
                              <input type = "submit" onclick="alert('Bill Payed!!!');" name ="bill" class ="btn btn-danger" value="Pay Bill"/>
                              </a>
                              </td>
                              </form>
